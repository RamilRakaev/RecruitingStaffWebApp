...
namespace RecruitingStaff.Infrastructure.Repositories.Migrations
{
    ...
    [Migration("20220117142143_TheEntitiesCandidateAndRecommenderAreRelated")]
    partial class TheEntitiesCandidateAndRecommenderAreRelated
    {
            ...
            modelBuilder.Entity("RecruitingStaff.Domain.Model.UserIdentity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "c9910eba-8d4c-4823-bc9a-b77f5b27969d",
                            Name = "user",
                            NormalizedName = "USER"
                        });
                });
