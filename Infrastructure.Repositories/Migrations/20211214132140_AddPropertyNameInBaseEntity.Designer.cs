...
namespace Infrastructure.Repositories.Migrations
{
    ...
    [Migration("20211214132140_AddPropertyNameInBaseEntity")]
    partial class AddPropertyNameInBaseEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandidateQuestionnaire", b =>
                {
                    b.Property<int>("CandidateQuestionnairesId")
                        .HasColumnType("integer");

                    b.Property<int>("CandidateQuestionnairesId1")
                        .HasColumnType("integer");

                    b.HasKey("CandidateQuestionnairesId", "CandidateQuestionnairesId1");

                    b.HasIndex("CandidateQuestionnairesId1");
            ...
            modelBuilder.Entity("CandidateVacancy", b =>
                {
                    b.Property<int>("CandidateVacanciesId")
                        .HasColumnType("integer");

                    b.Property<int>("CandidateVacanciesId1")
                        .HasColumnType("integer");

                    b.HasKey("CandidateVacanciesId", "CandidateVacanciesId1");

                    b.HasIndex("CandidateVacanciesId1");
            ...
            modelBuilder.Entity("RecruitingStaff.Domain.Model.UserIdentity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "e96941de-be98-4a11-a5a2-0e53172adcd7",
                            Name = "user",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("CandidateQuestionnaire", b =>
                {
                    b.HasOne("RecruitingStaff.Domain.Model.CandidateQuestionnaire.CandidateData.Candidate", null)
                        .WithMany()
                        .HasForeignKey("CandidateQuestionnairesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecruitingStaff.Domain.Model.CandidateQuestionnaire.Questionnaire", null)
                        .WithMany()
                        .HasForeignKey("CandidateQuestionnairesId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CandidateVacancy", b =>
                {
                    b.HasOne("RecruitingStaff.Domain.Model.CandidateQuestionnaire.CandidateData.Candidate", null)
                        .WithMany()
                        .HasForeignKey("CandidateVacanciesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecruitingStaff.Domain.Model.CandidateQuestionnaire.Vacancy", null)
                        .WithMany()
                        .HasForeignKey("CandidateVacanciesId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
