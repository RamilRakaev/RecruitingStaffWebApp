...
{
    public class AnswersOnQuestionHandler : IRequestHandler<AnswerOnQuestionQuery, Answer[]>
    {
        ...
        public Task<Answer[]> Handle(AnswerOnQuestionQuery request, CancellationToken cancellationToken)
        {
